        ...
        inputSchema: {
          ...
          properties: {
            address: {
              type: "string",
              description:
                "Full delivery address (e.g., '123 Main St, San Francisco, CA 94102')",
            },
          },
          required: ["address"],
        },
        ...
        inputSchema: {
          ...
          properties: {
            query: {
              type: "string",
              description:
                "Search query - restaurant name, food type, or dish (e.g., 'pizza', 'sushi', 'Chipotle')",
            },
            cuisine: {
              type: "string",
              description:
                "Filter by cuisine type (e.g., 'italian', 'chinese', 'mexican', 'american')",
            },
          },
          required: ["query"],
        },
        ...
        inputSchema: {
          ...
          properties: {
            restaurantId: {
              type: "string",
              description:
                "The restaurant ID or slug (from ubereats_search results)",
            },
          },
        ...
        inputSchema: {
          ...
          properties: {
            ...
            specialInstructions: {
              type: "string",
              description:
                "Special preparation instructions for the item (optional)",
            },
          },
        ...
        inputSchema: {
          ...
          properties: {
            confirm: {
              type: "boolean",
              description:
                "Set to true to place the order, false to preview only. Defaults to false for safety.",
            },
          },
          required: ["confirm"],
        },
        ...
        inputSchema: {
          ...
          properties: {
            orderId: {
              type: "string",
              description:
                "Order ID to track (optional - defaults to the most recent active order)",
            },
          },
        },
      },
  ...
  try {
    switch (name) {
          ...
          content: [
            {
              ...
              text: JSON.stringify({
                success: true,
                message:
                  "Uber Eats session cleared. You will need to log in again.",
              }),
            },
          ],
        };
      ...
      case "ubereats_add_to_cart": {
        const { restaurantId, itemName, quantity, specialInstructions } =
          args as {
            restaurantId: string;
            itemName: string;
            quantity?: number;
